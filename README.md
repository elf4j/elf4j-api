...
application using this ELF4J API can opt to use any logging provider (e.g. [LOG4J provider](https://github.com/elf4j/elf4j-log4j)) 
of the ELF4J SPI at deployment time, without any code change.
